...
public val MoonPhasesGroup.WaxingCescentMoonIndicator: ImageVector
    get() {
        ...
        _waxingCescentMoonIndicator = Builder(
            name = "WaxingCescentMoonIndicator", defaultWidth = 800.0.dp,
            ...
            path(
                ...
                arcTo(7.0f, 10.0f, 0.0f, true, false, 16.0f, 4.0f)
                close()
            }
            path(
...
private fun Preview(): Unit {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = MoonPhasesGroup.WaxingCescentMoonIndicator, contentDescription = "")
    }
}
