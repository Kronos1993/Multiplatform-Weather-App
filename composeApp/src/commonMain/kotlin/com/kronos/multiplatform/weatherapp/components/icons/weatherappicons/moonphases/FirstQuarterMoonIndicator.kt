...
public val MoonPhasesGroup.FirstQuarterMoonIndicator: ImageVector
    get() {
        if (_firstQuarterMoonIndicator != null) {
            return _firstQuarterMoonIndicator!!
        }
        _firstQuarterMoonIndicator = Builder(
            name = "FirstQuarterMoonIndicator", defaultWidth =
                800.0.dp, defaultHeight = 800.0.dp, viewportWidth = 32.0f, viewportHeight =
                32.0f
        ).apply {
            path(
