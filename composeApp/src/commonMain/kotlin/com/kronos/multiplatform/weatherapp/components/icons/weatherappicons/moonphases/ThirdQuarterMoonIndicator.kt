...
public val MoonPhasesGroup.ThirdQuarterMoonIndicator: ImageVector
    get() {
        if (_root_ide_package_.com.kronos.multiplatform.weatherapp.components.icons.weatherappicons.moonphases._thirdQuarterMoonIndicator != null) {
            return _root_ide_package_.com.kronos.multiplatform.weatherapp.components.icons.weatherappicons.moonphases._thirdQuarterMoonIndicator!!
        }
        _root_ide_package_.com.kronos.multiplatform.weatherapp.components.icons.weatherappicons.moonphases._thirdQuarterMoonIndicator = Builder(name = "ThirdQuarterMoonIndicator", defaultWidth =
            ...
            path(fill = SolidColor(Color(0xFFFFC10A)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcTo(1.0f, 10.0f, 0.0f, true, true, 16.0f, 4.0f)
                close()
            }
...
private var _thirdQuarterMoonIndicator: ImageVector? = null

@Preview
@Composable
private fun Preview(): Unit {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = MoonPhasesGroup.ThirdQuarterMoonIndicator, contentDescription = "")
    }
}
