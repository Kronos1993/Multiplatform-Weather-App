...
public val MoonPhasesGroup.ThirdQuarterMoonIndicator: ImageVector
    get() {
        if (_thirdQuarterMoonIndicator != null) {
            return _thirdQuarterMoonIndicator!!
        }
        _thirdQuarterMoonIndicator = Builder(
            name = "ThirdQuarterMoonIndicator", defaultWidth = 800.0.dp,
