...
public val MoonPhasesGroup.WaningGibbousMoonIndicator: ImageVector
    get() {
        ...
        _waningGibbousMoonIndicator = Builder(
            name = "WaningGibbousMoonIndicator", defaultWidth = 800.0.dp,
            ...
            path(
                ...
                arcTo(6.0f, 10.0f, 0.0f, true, false, 16.0f, 4.0f)
                close()
            }
            path(
...
private fun Preview(): Unit {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = MoonPhasesGroup.WaningGibbousMoonIndicator, contentDescription = "")
    }
}
